      ...
      >
        <div className="cyber-card flex items-center">
          ...
          <div>
            ...
            <h3 className="text-3xl font-bold neon-text">{mockData.stats.totalSolved}</h3>
          </div>
        </div>
        ...
        <div className="cyber-card flex items-center">
          ...
          <div>
            ...
            <h3 className="text-3xl font-bold neon-text">{mockData.stats.streak} days</h3>
          </div>
        </div>
        ...
        <div className="cyber-card flex items-center">
          ...
          <div>
            ...
            <h3 className="text-3xl font-bold neon-text">{mockData.stats.practiceTime}h</h3>
          </div>
        </div>
      </motion.div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-400">Keep your streak going! Practice DSA today.</p>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 space-y-4 md:space-y-0">
          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-center space-y-4 md:space-y-0 md:space-x-4 w-full md:w-auto">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link to="/add-question" className="cyber-button flex items-center space-x-2">
          ...
          {mockData.questions.map((question) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className={`px-4 py-2 rounded-lg text-sm ${statusColors[question.status]}`}>
                  {question.status}
                </span>
              </div>
            </Link>
